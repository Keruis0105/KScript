...
pub const impl = struct {
    pub inline fn avx256_f16_aligned_sub_vectorized(a: []const f16, b: []const f16, result: []f16) void {
        const len = a.len;
        var i: usize = 0;
    ...
    pub inline fn avx256_f32_aligned_sub_vectorized(a: []const f32, b: []const f32, result: []f32) void {
        const len = a.len;
        var i: usize = 0;
    ...
    pub inline fn avx256_f64_aligned_sub_vectorized(a: []const f64, b: []const f64, result: []f64) void {
        const len = a.len;
        var i: usize = 0;
